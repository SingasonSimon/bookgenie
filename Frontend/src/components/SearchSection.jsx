    ...
    >
      ...
      <div className="flex gap-3 items-center flex-wrap mb-6">
        ...
        {quickSearches.map((search, idx) => (
          <motion.button
            ...
            className="bg-primary-50 text-primary-600 border border-primary-200 px-4 py-2 rounded-full text-sm font-medium hover:bg-primary-500 hover:text-white hover:border-primary-500 transition-all duration-300"
          >
            {search}
          </motion.button>
        ))}
      ...
      <div className="flex gap-4 items-center flex-wrap">
        <div className="flex items-center gap-2">
          ...
          <label className="text-gray-600 font-medium text-sm">Genre:</label>
          <select
            value={filters.genre}
            onChange={(e) => onFilterChange('genre', e.target.value)}
            className="px-3 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-100 transition-all text-sm bg-white"
          >
        ...
        <div className="flex items-center gap-2">
          <label className="text-gray-600 font-medium text-sm">Level:</label>
          <select
